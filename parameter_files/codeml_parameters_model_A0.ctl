     ...
     treefile = species_tree_branches_annotated.nwk	* Path to the tree file
      outfile = codeml_results_model_A0.txt		* Path to the output file
    ...
    fix_omega = 1	       * Estimate or fix omega * 1: omega or omega_1 fixed, 0: estimate 
